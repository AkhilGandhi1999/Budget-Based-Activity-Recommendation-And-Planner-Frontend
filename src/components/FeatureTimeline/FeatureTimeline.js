...
export default defineComponent({
  ...
  data (){
    return{
      ...
      heading: ["Budget Based Recommendation","Hotel Recommendation", "Day and Night activities recommendation"
      ...
      "            both daytime and nighttime activities as well as recommendations for famous restaurants to dine at."]
